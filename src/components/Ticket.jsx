...
function Ticket({fullName, username, avatarUrl}) {
    ...
    return (<>
        <article 
            ...
            grid grid-cols-[85%_15%] grid-rows-2 grid-flow-col p-5'
        >
            ...
            <section className='grid grid-cols-[20%_auto] grid-rows-2'>
                <img src={avatarUrl} alt='avatar' className='aspect-square w-12 rounded-xl row-span-2 self-center'/>
                ...
                <div className='flex gap-2 content-center self-center'>
                    ...
                    <span className='text-sm text-neutral-400 font-light'>{username}</span>  
                </div>   
            </section>
